...
export const dict = {
  ...
  "session.preview.title": "Live preview",
  "session.preview.refresh": "Refresh",
  "session.preview.brief": "Brief",
  "session.preview.brief.description": "The brief the agent works from (AGENTS.md).",
  "session.preview.brief.save": "Save brief",
  "session.preview.brief.saved": "Saved",
  "session.preview.brief.saveError": "Could not save the brief.",
  "session.preview.brief.loadError": "Could not load the brief.",
  "session.siteMode.openError": "Could not open your site. Check that the server is running.",
  "session.siteMode.retry": "Try again",
